            ...
            <div class="card border-primary border-bottom border-3 border-0">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <input v-model="add.username" type="text" class="form-control" placeholder="Nhập vào họ và tên *">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <select v-model="add.role_id" class="form-control">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <div class="alert alert-primary" role="alert">
                                            <p>Bạn có chắc chắn muốn xoá <b class="text-danger">@{{del.username}}</b> không?</p>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <div class="mb-3">
                                            <label class="form-label">Họ Và Tên</label>
                                            <input v-model="edit.username" type="text" class="form-control" placeholder="Nhập vào họ và tên *">
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label">Email</label>
                                        ...
                                        <div class="mb-3">
                                            <label class="form-label">Quyền Tài Khoản</label>
                                            <select v-model="edit.role_id" class="form-control">
                                                @foreach ($quyen as $key => $value)
                                                    <option value="{{$value->id}}">{{$value->role_name}}</option>
                                                @endforeach
                                            </select>
    ...
    new Vue({
        ...
        methods : {
            ...
            changePassWord() {
                ...
                axios
                    .post('/admin/admin/change-password', this.password_new)
                    .then((res) => {
                        if(res.data.status) {
                            toastr.success(res.data.message);
                            this.loadData();
